...
func RunSimple(agent Agent, input string) (runner.AgentResponse, error) {
	return runner.Run(types.Agent(agent), runner.Input{OfString: input}, context.Background(), nil)
}
...
func RunWithContext(agent Agent, input string, globalContext agentcontext.AnyContext) (runner.AgentResponse, error) {
	return runner.Run(types.Agent(agent), runner.Input{OfString: input}, context.Background(), globalContext)
}
