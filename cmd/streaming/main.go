...
func main() {
	...
	go runner.Stream(&agent, "Your task is to find the weather in the hometown of Patrick Stewart. First think about where he is from.", context.Background(), responseChan)
